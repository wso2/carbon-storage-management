...
CREATE INDEX IF NOT EXISTS  INDEX_RM_USER_INSTANCE_ENTRY_DATABASE_USER_ID ON RM_USER_INSTANCE_ENTRY(DATABASE_USER_ID);
CREATE INDEX IF NOT EXISTS  INDEX_RM_USER_INSTANCE_ENTRY_RSS_INSTANCE_ID ON RM_USER_INSTANCE_ENTRY(RSS_INSTANCE_ID);

...
CREATE TABLE RM_DATABASE_USER (
  ...
  UNIQUE (USERNAME, TENANT_ID, ENVIRONMENT_ID, TYPE, INSTANCE_NAME),
  PRIMARY KEY (ID)
);
...
CREATE TABLE RM_USER_INSTANCE_ENTRY (
 ...
 CONSTRAINT fkUserInstanceEntryDBId FOREIGN KEY (DATABASE_USER_ID) REFERENCES RM_DATABASE_USER (ID ) ON DELETE CASCADE ON UPDATE CASCADE,
 CONSTRAINT fkUserInstanceEntryInstanceId FOREIGN KEY (RSS_INSTANCE_ID ) REFERENCES RM_SERVER_INSTANCE (ID ) ON DELETE CASCADE ON UPDATE CASCADE 
);

 ...
 *  under the License.
 */
package org.wso2.carbon.cassandra.cluster.mgt.exception;
...
public class ClusterDataAdminException extends Exception {
     ...
     */
    public ClusterDataAdminException(String msg, Log log) {
        super(msg);
        log.error(msg);
    }
     ...
     * @param log       Logger who need to consume message
     */
    public ClusterDataAdminException(String msg, Throwable throwable, Log log) {
        super(msg, throwable);

...
public class KeyspaceInfo {
    ...
    private ColumnFamilyInformation[] columnFamilyInformations;
    ...
    public ColumnFamilyInformation[] getColumnFamilyInformations() {
        return columnFamilyInformations;
    }

    public void setColumnFamilyInformations(ColumnFamilyInformation[] columnFamilyInformations) {
        this.columnFamilyInformations = columnFamilyInformations;
    }

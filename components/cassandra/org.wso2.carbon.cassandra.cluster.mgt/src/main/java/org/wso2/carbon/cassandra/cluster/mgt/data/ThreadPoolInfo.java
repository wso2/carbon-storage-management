...
public class ThreadPoolInfo {
    ...
    public ThreadPoolDroppedProperties[] getThreadPoolDroppedProperties() {
        return threadPoolDroppedProperties;
    }

    public void setThreadPoolDroppedProperties(
            ThreadPoolDroppedProperties[] threadPoolDroppedProperties) {
        this.threadPoolDroppedProperties = threadPoolDroppedProperties;
    }
}

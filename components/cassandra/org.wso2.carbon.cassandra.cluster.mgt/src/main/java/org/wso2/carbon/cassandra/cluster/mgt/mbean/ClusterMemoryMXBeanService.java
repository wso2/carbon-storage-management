...
public class ClusterMemoryMXBeanService {
    private static Log log = LogFactory.getLog(ClusterMemoryMXBeanService.class);
    private MemoryMXBean memoryMXBean;

    public ClusterMemoryMXBeanService() throws
    ...
    private void createProxyConnection() throws ClusterDataAdminException {
        ...
        try{
            memoryMXBean = clusterMBeanDataAccess.locateMemoryMBean();
        }
        catch(Exception e){
            throw new ClusterDataAdminException("Unable to locate memory service MBean connection",e,log);
        }
    }

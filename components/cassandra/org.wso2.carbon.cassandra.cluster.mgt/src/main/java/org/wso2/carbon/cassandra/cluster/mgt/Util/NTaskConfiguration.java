...
public class NTaskConfiguration{
    ...
    public static TaskInfo getTaskEnvironment(){
        ...
        props.put(ClusterConstants.CLUSTER_MONITOR_SERVICE_NAME,ClusterConstants.CLUSTER_STATS);
        return new TaskInfo(ClusterConstants.CLUSTER_STATS, ClusterDataPublisher.class.getName(), props, triggerInfo);
    }
}
...
<%
    ...
    try{
        ...
        ClusterNodeOperationsAdminClient clusterNodeOperationsAdminClient =new org.wso2.carbon.cassandra.cluster.mgt.ui.operation.ClusterNodeOperationsAdminClient(config.getServletContext(),session);
        clusterNodeOperationsAdminClient.startGossipServer(hostAddress);

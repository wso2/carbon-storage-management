...
<%
    ...
    try {
    	...
    	String path = CassandraAdminClientConstants.CASSANDRA_RESOURCE_ROOT + "/" + keyspaceName + "/" + cfName;
...
<script type="text/javascript">
    var callbackUrl = "cf_dashboard.jsp?cfName=<%=cfName%>&keyspaceName=<%=keyspaceName%>#permissionArea";
    showErrorDialog('<%=e.getMessage()%>', callbackUrl);
</script>
<%}%>

<script type="text/javascript">
   window.location = "cf_dashboard.jsp?cfName=<%=cfName%>&keyspaceName=<%=keyspaceName%>#permissionArea";
</script>
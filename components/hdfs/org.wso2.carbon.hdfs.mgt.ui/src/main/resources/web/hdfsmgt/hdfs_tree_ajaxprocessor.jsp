...
%>
            ...
            <a onclick="pickPath('<%=rootPath%>', '<%=textBoxId%>', '<%=rootName%>', 'true');" title="ROOT"><img style="margin-right: 2px;"
                                                                                            src="../hdfsmgt/images/folder.png"/>ROOT</a>
        </div>
...
%>
        ...
        <a onclick="pickPath('<%=rootPath%>', '<%=textBoxId%>', '<%=rootName%>', 'true');"><img style="margin-right: 2px;"

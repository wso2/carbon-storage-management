...
public class RSSManagerCommonException extends Exception {
    ...
    public RSSManagerCommonException(String message, Exception nestedEx) {
        super(message, nestedEx);
        setErrorMessage(message);
    }

    public RSSManagerCommonException(String message, Throwable cause) {
        super(message, cause);
        setErrorMessage(message);
    }

    public RSSManagerCommonException(String message) {
        super(message);
        setErrorMessage(message);
    }

    public RSSManagerCommonException(Throwable cause) {
        super(cause);
    }

...
/**
 * Class for hold MYSQL server privilege set information
 */
public class MySQLPrivilegeSetInfo extends DatabasePrivilegeSetInfo implements Serializable {

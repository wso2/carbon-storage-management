...
public class PersistenceManager {
	...
	public static void createEMF(final String fileName, RSSConfig currentRSSConfig){
		...
		try {	
			...
			while(iter.hasNext()){
				...
				String dataSourceName = currentRSSConfig.getRSSManagementRepository().getDataSourceConfig().getJndiLookupDefintion().getJndiName();
